...
function modeSombre() {
    ...
    header.classList.remove('bg-white'); // Enlève le blanc
    header.classList.add('shadow-lg', 'shadow-white/50', 'bg-black'); // Ajoute le noir
...
function modeClair() {
    ...
    header.classList.remove('shadow-lg', 'shadow-white/50', 'bg-black'); // Enlève le noir
    header.classList.add('bg-white'); // Remet le blanc
